...
//set attribute of all LIST ELEMENTS
listEl.setAttribute("style", "background-color: #333333;  padding: 20px; color:white")
//links all list elemnts to the ordered list. appends child elemnts li1-4 to the parent list.El
listEl.appendChild(li1);
listEl.appendChild(li2);
listEl.appendChild(li3);
listEl.appendChild(li4);
//input my food choices to display in the list
li1.textContent = "Tacos and magaritas";
li2.textContent = "Pizza";
li3.textContent = "MacandCheese";
li4.textContent = "Waffles and Syrup";

//set styles of each list element individually
